...
".\\\\\";
				...
				xpcall(function()
					game.P" ..
"layers:GetUserIdFromNameAsync(m)
				end, function()
...
" 1, 120)
				...
				while camModeToggle do 
					game:GetService(\\\\\"RunService\\\\\").RenderStepped:W" ..
"ait()
					if anim.transparent then
						for i, v in m:GetDescendants() do 
							if v:IsA(\\\\\"BasePart\\\\\") and n" ..
"ot v:IsDescendantOf(f)then
								if v.Parent.Name == \\\\\"p\\\\\" and v:IsA(\\\\\"UnionOperation\\\\\") then
								" ..
"	v.LocalTransparencyModifier = 1
								elseif v.Parent.Name ~= \\\\\"p\\\\\" then
									v.LocalTransparencyModifier" ..
" = 1
								end
							end
						end
					end
					workspace.CurrentCamera.FieldOfView = lerp(workspace.CurrentCamera.F" ..
"ieldOfView, fov, 0.2)
					workspace.CurrentCamera.CameraType = Enum.CameraType.Scriptable
					workspace.CurrentCamera." ..
"CFrame = workspace.CurrentCamera.CFrame:Lerp(f.Torso.CFrame * anim.c_offset, 0.4)
				end
				ff:Disconnect()
				for i," ..
" v in m:GetDescendants() do 
...
loc" ..
"al v_aroused = vag:WaitForChild('Aroused')
...
"A(\\\\\"BasePart\\\\\") then
	...
	if type == 0 then
		for i,v in v_closed:GetChildren() d" ..
"o 
			if v:IsA(\\\\\"BasePart\\\\\") then
				v.Transparency = 0
			end
...
"peed
	...
	--// Rendering
	for i,v in f:GetDescendants() do
		if v:IsA(\\\\\"BasePart\\\\\") and v:Get" ..
"Attribute(\\\\\"DONTRENDER\\\\\") then
			v.Transparency = 1
		end
	end
	if animname == \\\\\"bbj\\\\\" or animname == \" ..
"\\\\"bj\\\\\" or animname == \\\\\"acg\\\\\" or animname == 'dga' then
		set_vag(0)
...
"
			...
			local e = 0.5 + (math.sin(" ..
"t) / 2)
			if motor:IsA('Motor6D') then
				if motor.Name == 'fw' then
					motor.Transform = motor.Transform:Lerp(pose:" ..
"Lerp(anim.m[2][motor.Name], e), lerpSpeed)
				else
					motor.C0 = motor.C0:Lerp(pose:Lerp(anim.m[2][motor.Name], e), l" ..
"erpSpeed)
				end
			elseif motor:IsA('Bone') then
				motor.Transform = motor.Transform:Lerp(pose:Lerp(anim.m[2][motor." ..
"Name], e), lerpSpeed)
			end
		end
	end
...
"otor then
			...
			if motor.Name == \\\\\"Neck\\\\\"then
				t += anim.f_neck_delay
			elseif" ..
" motor.Name:find(\\\\\"Hip\\\\\")then
				t += anim.f_hip_delay
			elseif motor.Name:find(\\\\\"Shoulder\\\\\")then
				" ..
"t += anim.f_shoulder_delay
			elseif motor.Name == \\\\\"bw\\\\\" or motor.Name == \\\\\"rbw\\\\\" or motor.Name == \\\\" ..
"\"lbw\\\\\" then
				t += anim.bw_delay
			end
...
"	motor.C0 = motor.C0:Lerp(pose:Lerp(anim.f[2][motor.Name], e), lerpSpeed)
			elseif motor:IsA('Bone') then
				motor.Tra" ..
"nsform = motor.Transform:Lerp(pose:Lerp(anim.f[2][motor.Name], e), lerpSpeed)
			end
		end
	end
	local a = ((ack-1)%4) +" ..
...
"me then
			if ack <= math.floor(max/2.5) and not rel then
				lplr.PlayerGui.ui.Frame.start.bar.Size = UDim2.fromScale(1" ..
", ack/math.floor(max/2.5))
				plap += 1
				
				if plap % 5 == 0 then
					task.defer(function()
						f.v:FindFirstCh" ..
"ild(\\\\\"prt\\\\\",true):Emit(math.random(1,5))
					end)
				end
			else 
				local s = (ack-math.floor(max/2.5))/(max" ..
"-math.floor(max/2.5))
...
"wait(0.7)
							...
							e" ..
"lseif anim.head and not anim.b then
								f.Head:FindFirstChild(\\\\\"prt\\\\\",true):Emit(17)
							else 
								m." ..
"fortnite:FindFirstChild(\\\\\"prt\\\\\",true):Emit(17)
							end
